  ...
  if (items.length === 0) {
    return (
      <Box sx={{ py: 6, textAlign: 'center' }}>
        <Typography variant="body2" color="text.disabled">Nessuna attività registrata</Typography>
      </Box>
    );
  }
  ...
  return (
    <Box>
      {groups.map((group, gi) => (
        <Box key={gi}>
          {/* Day label */}
          <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1, mt: gi > 0 ? 2.5 : 0 }}>
                ...
                >
                  ...
                  <Box flex={1} minWidth={0}>
                    ...
                    <Stack direction="row" alignItems="center" spacing={0.75} flexWrap="wrap">
                      ...
                      >
                        <Typography sx={{ fontSize: 9, fontWeight: 700, color: meta.color, fontFamily: 'monospace', lineHeight: 1.6 }}>
                          {item.change.target}
                        </Typography>
                      </Box>
                    </Stack>
